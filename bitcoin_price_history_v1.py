...
# Bitcoin price data for each month, corrected
dates = [
...
# Plot the price data
ax.plot(dates, prices, marker='o', linestyle='-', color='blue', label='Bitcoin Price')
...
# Use log scale for y-axis to handle the wide range of prices
ax.set_yscale('log')
...
# Add legend, ensuring only one halving label is shown
